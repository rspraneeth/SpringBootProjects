...
public class QuestionService {
    ...
    public List<QuestionWrapper> getQuestions(){
        return questionDao.findAll().stream().map(question -> new QuestionWrapper(question.getId(), question.getQuestionTitle(), question.getOption1(), question.getOption2(), question.getOption3(), question.getOption4())).collect(Collectors.toList());
    }
}
